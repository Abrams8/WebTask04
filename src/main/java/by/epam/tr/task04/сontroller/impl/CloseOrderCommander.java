...
public class CloseOrderCommander implements Command {

    private static final Logger log = LogManager.getLogger(CloseOrderCommander.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("MyController?command=GET_ALL_CONFIRMED_ORDERS");
